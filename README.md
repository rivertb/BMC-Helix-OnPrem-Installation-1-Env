...
| 3 | helix-k8s-master.bmc.local | 192.168.1.200 | Rocky9 | 4 vCPU * 8 GB RAM * 100 HDD | k8s master node | rancher master node |
| 4 | helix-k8s-worker01.bmc.local | 191.168.1.201 | Rocky9 | 16 vCPU * 64 GB RAM * 100 HDD | k8s worker node 1 | rancher worker node |
| 5 | helix-k8s-worker02.bmc.local | 191.168.1.202 | Rocky9 | 16 vCPU * 64 GB RAM * 100 HDD | k8s worker node 2 | rancher worker node |
| 6 | helix-k8s-worker03.bmc.local | 191.168.1.203 | Rocky9 | 16 vCPU * 64 GB RAM * 100 HDD | k8s worker node 3 | rancher worker node |
| 7 | helix-k8s-worker04.bmc.local | 191.168.1.204 | Rocky9 | 16 vCPU * 64 GB RAM * 100 HDD | k8s worker node 4 | rancher worker node |
